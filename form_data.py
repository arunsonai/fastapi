...
@app.get("/")
async def get_root():
    return {"message" : "Hello Form Data"}
...
For example, in one of the ways the OAuth2 specification can be used (called "password flow") it
is required to send a username and password as form fields.
